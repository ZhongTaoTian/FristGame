...
namespace DollarRecognizer
{
	...
	void GeometricRecognizer::loadTemplates()
	{
        ...
        addTemplate("Circle", samples.getGestureCircle2());
        
		addTemplate("Star", samples.getGestureStar());
        addTemplate("Star", samples.getGestureStar1());
        
        addTemplate("LessThan", samples.getGestureLeftGreater());
        addTemplate("LessThan", samples.getGestureRightGreater());
        
        addTemplate("Lightning", samples.getGestureLightning());
        addTemplate("Lightning", samples.getGestureLightning1());
        
        addTemplate("Z", samples.getGestureZ());
        addTemplate("Z", samples.getGestureZ1());
        
        addTemplate("M", samples.getGestureM());
        addTemplate("M", samples.getGestureW());
        addTemplate("M", samples.getGestureM1());
        
        addTemplate("Plait", samples.getGestureTopPigtail());
        addTemplate("Plait", samples.getGestureBottomPigtail());
        addTemplate("Plait", samples.getGestureBottomPigtail1());
        addTemplate("Plait", samples.getGestureBottomPigtail22());
        
        addTemplate("Triangle", samples.getGestureTriangle());
        addTemplate("Triangle", samples.getGestureTriangle1());
        
        addTemplate("Wave", samples.getGestureWave());
        addTemplate("Wave", samples.getGestureWave1());
        
        addTemplate("Bow", samples.getGestureRightBow());
        addTemplate("Bow", samples.getGestureLeftBow());
        addTemplate("Bow", samples.getGestureBow1());
        
        addTemplate("S", samples.getGestureS());
        addTemplate("S", samples.getGestureS1());
        
        addTemplate("Ladder", samples.getGestureLadder());
        addTemplate("Ladder", samples.getGestureLadder1());
        
        addTemplate("Eight", samples.getGesture8());
        addTemplate("Eight", samples.getGesture81());
        addTemplate("Eight", samples.getGesture82());
        addTemplate("Eight", samples.getGesture83());
        
        addTemplate("Knot", samples.getGestureKnot());
        addTemplate("Knot", samples.getGestureKnot1());
	}
